...
const Home: React.FC = () => {
    ...
    const cardClass = `
    relative group p-6 rounded-xl cursor-pointer flex flex-col h-full transition-all duration-300
    bg-white border border-gray-200 shadow-sm
    hover:border-blue-400/50 hover:shadow-lg hover:-translate-y-1
    dark:bg-[#1E1E1E] dark:border-[#333] dark:shadow-none dark:hover:border-gray-500
  `;
        ...
        <div className="py-8 pb-20">
            ...
            <div className="space-y-16">
                {filteredCategories.length === 0 ? (
                    <div className="text-center text-gray-500 dark:text-gray-400 py-12 rounded-xl bg-white dark:bg-[#1E1E1E] border border-gray-200 dark:border-[#333]">
                        ...
                        return (
                            <div key={category.id} className="animate-fade-in-up">
                                <div className="flex items-center gap-4 mb-6 px-2">
                                    ...
                                    <div className="h-px bg-gradient-to-r from-gray-200 to-transparent dark:from-[#333] dark:to-transparent flex-1"></div>
                                </div>
                                    ...
                                    {categoryTools.map((tool) => (
                                        ...
                                        >
                                            <div className="flex items-start justify-between mb-4">
                                                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-[#252526] dark:to-[#1E1E1E] border border-gray-200 dark:border-[#333] flex items-center justify-center text-2xl shadow-sm dark:shadow-none group-hover:scale-110 transition-transform duration-300">
                                                    {tool.icon}
                                                </div>
